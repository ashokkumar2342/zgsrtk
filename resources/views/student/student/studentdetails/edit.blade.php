                                        ...
                                        <div class="col-md-12">
                                             ...
                                             <div class="col-lg-4">                         
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('date_of_admission','',array('class' => 'form-control','data-inputmask'=>"'alias': 'dd/mm/yyyy'", 'data-mask' )) }}
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                      <div class="input-group-addon">
                                                        ...
                                                        {{ Form::text('date_of_birth','',['class'=>'form-control required','data-inputmask'=>"'alias': 'dd/mm/yyyy'", 'data-mask']) }}
                                                    </div>
