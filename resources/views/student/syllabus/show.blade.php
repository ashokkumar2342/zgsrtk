            ...
            <div class="container">            
               <div class="gallery-items">  
                  ...
                  <div class="gallery-item branding packing">
                    ...
                    <br>
                      <img src="{!! url('uploads/holidayhomework/'.$syllabus->syllabus) !!}" style="height:240px;width: 358px; " alt="dance" class="img-responsive thumbnail">
                      <div class="gallery-overlay"> </div>
                      <div class="gallery-content">
                        <a href="{!! url('uploads/holidayhomework/'.$syllabus->syllabus) !!}" data-rel="lightcase:myCollection"><i class="icon flaticon-expand"></i></a>                               
                      </div>
                    </div>
                  </div><!-- gallery item -->                   
