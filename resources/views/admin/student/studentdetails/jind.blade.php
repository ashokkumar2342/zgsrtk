...
@section('body')
    ...
    <section class="content">
        <div class="box">
            ...
            <button type="hidden" hidden id="btn_show" data-table-without-pagination="dataTable"  onclick="callAjax(this,'{{ route('student.huda.all',2) }}','result_student')">show</button>
            <!-- /.box-header -->
